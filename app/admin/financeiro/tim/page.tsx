...
export default async function FinanceiroTimPage() {
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-6">
          ...
          <p className="mt-2 text-sm" style={{ color: "var(--onity-dark-text-muted)" }}>
            Colaboradores importados via CSV do Time Is Money.
          </p>
        ...
        <AdminFinanceiroDashboard canEditFinanceiro={canEditFinanceiro} serviceFilter="timeIsMoney" />
      </div>
    </main>
  );
}
