...
export default async function FinanceiroCfComBrPage() {
    ...
    <main className="relative z-10 min-h-screen">
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mb-6">
          ...
          <h1 className="mt-2 text-2xl font-bold text-white sm:text-3xl">CFCONTABILIDADE.COM.BR</h1>
          <p className="mt-2 text-sm" style={{ color: "var(--onity-dark-text-muted)" }}>
            Usuários Google Workspace do servidor CFCONTABILIDADE.COM.BR.
          </p>
        ...
        <AdminFinanceiroDashboard canEditFinanceiro={canEditFinanceiro} serviceFilter="cfComBr" />
      </div>
    </main>
  );
}
